                            ...
                            <div class="row g-4">
                                <div class="col-lg-7">
                                    ...
                                    <div class="action-group justify-content-center mb-4">
                                        ...
                                        @else
                                            <button id="btnMasuk" class="btn btn-absen btn-success-absen text-white"
                                                {{ $cek && $cek->jam_masuk ? 'disabled' : '' }}>
                                                <i data-feather="log-in" class="me-1"></i> Absen Masuk
                                            </button>
                                            <button id="btnPulang" class="btn btn-absen btn-danger-absen text-white"
                                                        ...
                                                        <tbody>
                                                            @foreach ($sesiHariIni as $sesi)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><span
                                                                            class="badge bg-{{ $sBadge }} text-capitalize">{{ $sesi->status }}</span>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                                ...
                                                <div
                                                    ...
                                                    <span>
                                                        ...
                                                        @else
                                                            ...
                                                            @endphp
                                                            <span
                                                                class="badge bg-{{ $statusBadge }} text-capitalize px-3 py-2">{{ $cek->status }}</span>
                                                        @endif
                                                    </span>
                                                </div>
                                                <div
                                                    ...
                                                    <span
                                                        class="badge bg-light text-dark border px-3 py-2">{{ $cek->jam_masuk ?? '--:--:--' }}</span>
                                                </div>
                                                <div
                                                    class="list-group-item px-0 d-flex justify-content-between align-items-center bg-transparent">
                                                    <span class="fw-semibold text-gray-700">Waktu Pulang</span>
                                                    <span
                                                        class="badge bg-light text-dark border px-3 py-2">{{ $cek->jam_keluar ?? '--:--:--' }}</span>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                                    @if (auth()->user()?->status_gaji === 'bulanan')
                                        <div class="info-box p-4">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <span
                                                    class="fw-bold">{{ $shift_start ? \Carbon\Carbon::parse($shift_start)->format('H:i') : '-' }}
                                                    WIB</span>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="text-muted">Jam Pulang</span>
                                                <span
                                                    class="fw-bold">{{ $shift_end ? \Carbon\Carbon::parse($shift_end)->format('H:i') : '-' }}
                                                    WIB</span>
                                            </div>
                                            <div class="helper-text mb-0">
                                                Bila ada kendala, hubungi admin atau mandor sebelum meninggalkan lokasi
                                                kerja.
                                            </div>
                                        </div>
                                    @endif
    ...
    <script>
        ...
        function bukaKameraFullScreen(judulAbsen, urlAbsen) {
            ...
            overlay.style.cssText =
                'position:fixed;top:0;left:0;width:100%;height:100%;background:#000;z-index:9999;display:flex;flex-direction:column;';
                ...
                didOpen: () => {
                    ...
                    navigator.mediaDevices.getUserMedia({
                        ...
                        videoEl.style.cssText =
                            'width:100%!important;height:100%!important;display:block!important;transform:scaleX(-1)!important;object-fit:cover!important;position:absolute!important;top:0!important;left:0!important;max-width:none!important;max-height:none!important;';
                        videoEl.onloadedmetadata = () => videoEl.play();
                        videoEl.onplaying = () => setTimeout(() => {
                            videoReady = true;
                            loadingDiv.style.display = 'none';
