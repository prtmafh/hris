            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-auto mb-3 d-flex gap-2">
                        <a href="{{ route('data_absenKaryawan') }}" class="btn btn-sm btn-light">
                            <i data-feather="arrow-left"></i>
                            Kembali
                        </a>
                        <a href="{{ route('karyawan.absensi.edit',$absensi->id) }}" class="btn btn-sm btn-primary">
                        ...
                        <form id="delete-form-{{ $absensi->id }}"
                            action="{{ route('karyawan.absensi.destroy',$absensi->id) }}" method="POST"
                            style="display:none;">
                            @csrf
                            @method('DELETE')
                        </form>
