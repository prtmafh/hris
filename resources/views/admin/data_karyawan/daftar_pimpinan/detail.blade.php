        ...
        <div class="container-xl px-4">
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-auto mb-3">
                        <a href="{{ route('admin.daftar_pimpinan') }}" class="btn btn-sm btn-light">
                            <i data-feather="arrow-left"></i> Kembali
                        </a>
                        <a href="{{ route('admin.daftar_pimpinan.edit', $karyawan->id) }}"
            ...
            <div class="col-xl-4">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                            ...
                            <form action="{{ route('admin.daftar_pimpinan.toggleKaryawanStatus', $karyawan->id) }}"
                                method="POST">
                                @csrf
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.daftar_pimpinan.resetPassword', $karyawan->id) }}" method="POST"
