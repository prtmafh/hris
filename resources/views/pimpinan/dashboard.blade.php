                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-12 col-xl-auto mt-4">
                        <div class="input-group input-group-joined border-0" style="width: 16.5rem">
                            ...
                            <input class="form-control ps-0" value="{{ $now->locale('id')->isoFormat('D MMMM YYYY') }}"
                                readonly />
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xl-3 mb-4">
                <div class="card bg-success text-white h-100">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between small">
                        <a class="text-white stretched-link" href="{{ route('pimpinan.laporan.absensi') }}">Lihat
                            Laporan</a>
                        <div class="text-white"><i class="fas fa-angle-right"></i></div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 mb-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span class="badge bg-success-soft text-success fw-bold">{{ $ringkasanAbsensi['hadir']
                                    }}</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="text-muted small">Terlambat</span>
                                <span class="badge bg-warning-soft text-warning fw-bold">{{
                                    $ringkasanAbsensi['terlambat'] }}</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="text-muted small">Izin</span>
                                <span class="badge bg-info-soft text-info fw-bold">{{ $ringkasanAbsensi['izin']
                                    }}</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="text-muted small">Alpha</span>
                                <span class="badge bg-danger-soft text-danger fw-bold">{{ $ringkasanAbsensi['alpha']
                                    }}</span>
                            </div>
                            <hr>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="card-footer text-end">
                            <a href="{{ route('pimpinan.laporan.absensi') }}" class="btn btn-sm btn-primary">Laporan
                                Lengkap</a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="h4 text-success mb-0">Rp {{ number_format($totalGajiBulanIni, 0, ',', '.') }}
                            </div>
                        </div>
                        <div class="card-footer text-end">
                            <a href="{{ route('pimpinan.laporan.penggajian') }}" class="btn btn-sm btn-primary">Laporan
                                Gaji</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="text-center text-muted py-5">
                                ...
                                <a href="{{ route('pimpinan.penilaian.create') }}" class="btn btn-primary btn-sm">Mulai
                                    Menilai</a>
                            </div>
                            @else
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-muted small">{{ $p->karyawan->jabatan->nama_jabatan ?? '-'
                                                }}</td>
                                            <td>
                                                ...
                                                <small class="text-muted">{{ number_format($p->nilai_total, 1)
                                                    }}</small>
                                            </td>
                                            <td>
                                                @php $gradeColor =
                                                ['A'=>'success','B'=>'primary','C'=>'warning','D'=>'danger'][$p->grade]
                                                ?? 'secondary'; @endphp
                                                <span
                                                    class="badge bg-{{ $gradeColor }}-soft text-{{ $gradeColor }} fw-bold fs-6">{{
                                                    $p->grade }}</span>
                                            </td>
                                            <td>
                        ...
                        @if(!$penilaianTerakhir->isEmpty())
                        <div class="card-footer text-end">
                            <a href="{{ route('pimpinan.penilaian.index') }}" class="btn btn-sm btn-primary">Semua
                                Penilaian</a>
                        </div>
                        @endif
                    </div>
