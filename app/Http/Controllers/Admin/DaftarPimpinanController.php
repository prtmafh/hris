...
class DaftarPimpinanController extends Controller
{
    public function index()
    {
        ...
        return view(
            'admin.data_karyawan.daftar_pimpinan.index',
    ...
    public function store(Request $request)
    {
        ...
        $roleKaryawan = Role::where('nama_role', 'pimpinan')->first();
        Karyawan::create([
    ...
    public function storeView()
    {
        ...
        return view('admin.data_karyawan.daftar_pimpinan.tambah', compact('jabatan'));
    }
    ...
    public function detail($id)
    {
        ...
        $jabatan  = Jabatan::all();
        return view('admin.data_karyawan.daftar_pimpinan.detail', compact('karyawan', 'jabatan'));
    }
    ...
    public function updateView($id)
    {
        $karyawan = Karyawan::with(['jabatan'])->findOrFail($id);
        $jabatan  = Jabatan::all();
        return view('admin.data_karyawan.daftar_pimpinan.edit', compact('karyawan', 'jabatan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('admin.daftar_pimpinan.show', $karyawan->id)
    ...
    public function toggleKaryawanStatus($id)
    {
        ...
        return redirect()->back()->with('success', "Status pimpinan {$karyawan->nama} berhasil diperbarui.");
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success', 'Data pimpinan berhasil dihapus.');
    }
}
